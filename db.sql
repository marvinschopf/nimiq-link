...
CREATE TABLE `clicks` ( `id` INT NOT NULL AUTO_INCREMENT , `link` VARCHAR(255) NOT NULL , `date` DATE NOT NULL , `clicks` INT NOT NULL , PRIMARY KEY (`link`, `date`), UNIQUE `id` (`id`)) ENGINE = InnoDB;
