...
CREATE TABLE `clicks` ( `id` INT NOT NULL AUTO_INCREMENT , `link` VARCHAR(255) NOT NULL , `date` DATE NOT NULL , `clicks` INT NOT NULL DEFAULT '1' , PRIMARY KEY (`id`), UNIQUE `link` (`link`), UNIQUE `date` (`date`)) ENGINE = InnoDB;
ALTER TABLE `clicks` ADD FOREIGN KEY (`link`) REFERENCES `links`(`id`) ON DELETE CASCADE ON UPDATE NO ACTION;
