...
CREATE TABLE `clicks` ( `id` INT NOT NULL AUTO_INCREMENT , `link` VARCHAR(255) NOT NULL , `date` DATE NOT NULL , `clicks` INT NOT NULL DEFAULT '1' , PRIMARY KEY (`id`, `link`), UNIQUE `date` (`date`)) ENGINE = InnoDB;
